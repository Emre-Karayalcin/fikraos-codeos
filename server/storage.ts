  ...
  async getPitchDeckGenerationsByUser(userId: string): Promise<(PitchDeckGeneration & { projectTitle?: string })[]> {
    const rows = await db
      .select({
        ...
        lifecycleStatus: pitchDeckGenerations.lifecycleStatus,
        draftNotes: pitchDeckGenerations.draftNotes,
        lastAutoSavedAt: pitchDeckGenerations.lastAutoSavedAt,
        submittedAt: pitchDeckGenerations.submittedAt,
        submittedById: pitchDeckGenerations.submittedById,
        isLocked: pitchDeckGenerations.isLocked,
        lockedAt: pitchDeckGenerations.lockedAt,
        lockedReason: pitchDeckGenerations.lockedReason,
        lockedById: pitchDeckGenerations.lockedById,
