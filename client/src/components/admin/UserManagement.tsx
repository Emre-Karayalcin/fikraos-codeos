                          ...
                          <DropdownMenuContent align="end">
                            {member.role !== 'OWNER' && (
                              <>
                                ...
                                <DropdownMenuItem
                                  onClick={() => updateRoleMutation.mutate({ userId: member.user.id, role: 'JUDGE' })}
                                  disabled={member.role === 'JUDGE'}
                                >
                                  Make Judge
                                </DropdownMenuItem>
                                <DropdownMenuItem
                                  onClick={() => updateRoleMutation.mutate({ userId: member.user.id, role: 'CLIENT' })}
