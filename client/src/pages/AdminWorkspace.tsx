...
export default function AdminWorkspace() {
  ...
  const editableRoutesDefault = [
    ...
    { key: 'navigation.challenges', prefix: 'challenges', path: '/challenges', label: { en: 'Challenges', ar: 'التحديات' }, desc: { en: 'Join innovative challenges and compete with entrepreneurs across the MENA region', ar: 'انضم إلى تحديات مبتكرة وتنافس مع رواد الأعمال في منطقة الشرق الأوسط وشمال أفريقيا' } },
